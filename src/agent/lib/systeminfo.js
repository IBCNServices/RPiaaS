...
exports.cpuTemp = function (callback) {
	if (fs.existsSync('/sys/class/thermal/thermal_zone0/temp')) {
		...
		callback(null, { "temperature": 0 }); // File does not exist, return 0 (or error?)
	}
};
